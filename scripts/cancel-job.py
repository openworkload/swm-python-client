...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cancel specified job.")
    parser.add_argument("--job-id", help="Job ID to cancel", required=True)
    ...
    output = swm_api.cancel_job(args.job_id)
