...
class RemoteSite:
    ...
    Attributes:
        id (Union[Unset, str]): Remote site ID
        name (Union[Unset, str]): Remote site name in Sky Port
        account_id (Union[Unset, str]): Account ID
        server (Union[Unset, str]): Remote site server hostname
        port (Union[Unset, int]):
        kind (Union[Unset, str]): Remote site kind
        default_image_id (Union[Unset, str]): Default image ID
        default_flavor_id (Union[Unset, str]): Default flavor ID
    """
